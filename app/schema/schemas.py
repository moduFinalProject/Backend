...
class ResumeCreate(BaseModel):
    ...
    title: str = Field(min_length=2, max_length=100, description="이력서 제목")
...
class FeedbackContentAI(BaseModel):
    ...
    feedback_devision : Literal['1','2','3','4'] = Field(description="피드백 분류 1:잘된 부분, 2:필수 수정 사항,3:개선 제안 사항, 4: 추가 권장사항")
